...
env = HandoverEnv(render_mode="human", tasks_to_complete = ["panda_giver_fetch", "object_lift", "object_move","panda_reciever_wait", "object_stable"], max_episode_steps=1200)
env.reset()
